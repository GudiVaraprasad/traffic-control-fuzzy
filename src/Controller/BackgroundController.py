...
class BackgroundController:
    ...
    def draw_spawn_rate_buttons(self):
        ...
        self.surface.blit(normal_font.render('Horizontal Speed:', True, self.white), (5, 25))
        fonts = [normal_font, normal_font, normal_font]
        colors = [self.white, self.white, self.white]
        ...
        self.surface.blit(normal_font.render('Spawn Rate (Vertical):', True, self.white), (5, 45))
        fonts = [normal_font, normal_font, normal_font]
        colors = [self.white, self.white, self.white]
    ...
    def draw_moving_averages(self, moving_averages):
        normal_font = pygame.font.SysFont('Sans-serif', 25)
        self.surface.blit(normal_font.render('Vehicles behind traffic(Horizontal):', True, self.white), (5, 65))
        self.surface.blit(normal_font.render('{0:.2f}'.format(moving_averages[Lane.left_to_right]), True, self.white), (320, 65))
        self.surface.blit(normal_font.render('Vehicles behind traffic(Vertical):', True, self.white), (5, 85))
        self.surface.blit(normal_font.render('{0:.2f}'.format(moving_averages[Lane.top_to_bottom]), True, self.white), (320, 85))

    def draw_vehicle_count(self, total):
        font = pygame.font.SysFont('Sans-serif', 25)
        text_surface = font.render('Total Vehicles: {}'.format(total), True, self.white)
    ...
    def draw_road_markings(self):
        ...
        traffic_yelloww = Config['colors']['traffic_yelloww']
        ...
        #building
        yb_top, yb_left, yb_bottom, yb_right = Config['background']['building']
        yellow_box_junction_img = os.path.join(os.getcwd(), 'images', 'buildings', 'b4.jpg')
        picture = pygame.image.load(yellow_box_junction_img)
        picture = pygame.transform.scale(picture, (yb_left + yb_right, yb_top + yb_bottom))
        yellow_box_junction_img = os.path.join(os.getcwd(), 'images', 'buildings', 'b5.jpg')
        picture2 = pygame.image.load(yellow_box_junction_img)
        picture2 = pygame.transform.scale(picture2, (yb_left + yb_right, yb_top + yb_bottom))
        yellow_box_junction_img = os.path.join(os.getcwd(), 'images', 'buildings', 'b3.jpg')
        picture3 = pygame.image.load(yellow_box_junction_img)
        picture3 = pygame.transform.scale(picture3, (yb_left + yb_right, yb_top + yb_bottom))
        yellow_box_junction_img = os.path.join(os.getcwd(), 'images', 'buildings', 'b1.jpg')
        picture1 = pygame.image.load(yellow_box_junction_img)
        picture1 = pygame.transform.scale(picture1, (yb_left + yb_right, yb_top + yb_bottom))
        road = os.path.join(os.getcwd(), 'images', 'buildings', 'road1.png')
        road = pygame.image.load(road)
        picture1 = pygame.image.load(yellow_box_junction_img)
        picture1 = pygame.transform.scale(picture1, (yb_left + yb_right, yb_top + yb_bottom))
        road2 = os.path.join(os.getcwd(), 'images', 'buildings', 'road3.png')
       
        road2 = pygame.image.load(road2)
        pool=os.path.join(os.getcwd(), 'images', 'buildings', 'pool.png')
        pool = pygame.image.load(pool)
        self.surface.blit(pool,(400,0))
        
        self.surface.blit(road,(378,0))
        self.surface.blit(road,(378,450))
        self.surface.blit(road2,(0,380))
        self.surface.blit(road2,(450,380))
        
        self.surface.blit(picture2, (8,225))
        self.surface.blit(picture2, (168,225))
        self.surface.blit(picture3, (460,225))
        self.surface.blit(picture3, (620,225))
      
        self.surface.blit(picture, (self.screen_width  - yb_left, self.screen_height  - yb_top))
        self.surface.blit(picture, (self.screen_width  - yb_left-80, self.screen_height  - yb_top))
       
        self.surface.blit(picture, (self.screen_width  - yb_left-230, self.screen_height  - yb_top))
        self.surface.blit(picture1, (self.screen_width  - yb_left, 470))
        self.surface.blit(picture1, (self.screen_width  - yb_left-80, 470))
    
        self.surface.blit(picture1, (self.screen_width  - yb_left-230, 470))
        self.surface.blit(picture, (8,710))
        self.surface.blit(picture, (8,550))
        self.surface.blit(picture, (8,470))
       
      
        self.surface.blit(picture, (179,710))
        self.surface.blit(picture, (179,550))
        self.surface.blit(picture, (179,470))
        ...
        while y >= 0:
            pygame.draw.rect(self.surface, traffic_yelloww, (x1, y, road_marking_width, road_marking_length))
            pygame.draw.rect(self.surface, traffic_yelloww, (x2, y, road_marking_width, road_marking_length))
        ...
        while x >= 0:
            pygame.draw.rect(self.surface, traffic_yelloww, (x, y1, road_marking_length, road_marking_width))
            pygame.draw.rect(self.surface, traffic_yelloww, (x, y2, road_marking_length, road_marking_width))
    ...
    def draw_switch_traffic_button(self):
        ...
        text_surface = font.render('Switch', True, self.red)
        ...
        w = rect.width + gap * 2
        h = rect.height + gap * 2
        pygame.draw.rect(self.surface, self.red, (x, y, w, h), 3)
        self.switch_traffic_button = rect

    def draw_fuzzy_button(self):
        font = pygame.font.SysFont('Comic Sans MS', 16)
        text_surface = font.render('Calculate Fuzzy', True, self.red)
        ...
        w = rect.width + gap * 2
        h = rect.height + gap * 2
        pygame.draw.rect(self.surface, self.blue, (x, y, w, h), 3)
        self.fuzzy_button = rect

    def draw_fuzzy_score(self, fuzzy_score, current_lane: DoubleLane):
        normal_font = pygame.font.SysFont('Sans-serif', 20)
        opposite_lane_name = 'Horizontal' if current_lane == DoubleLane.Vertical else 'Vertical'
        self.surface.blit(normal_font.render('Fuzzy Green Light Ext. ({} Lane): '.format(opposite_lane_name), True, self.white), (5, 105))

        score = '-'
        if fuzzy_score:
            score = '{:.2f}s'.format(fuzzy_score)
        self.surface.blit(normal_font.render(score, True, self.white), (320, 105))
